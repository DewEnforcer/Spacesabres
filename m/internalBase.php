    ...
    <main>
      ...
      <section class="base_container">
        <div class="top_container_base_title">
          <h2>Battlestation overview</h2>
          <button type="button" name="button" class="button_help_base" id="base">Help</button>
        </div>

        <form class="modules" action="./include/modulesHandler.php" method="post">
          ...
          <div class="module1 module_divs"><h3>Module slot 1</h3><img src="../image/graphics/module<?php echo $modules["slot1"] ?>.png" alt="module"><br><select name="module1" >
        ...
        <div class="module2 module_divs"><h3>Module slot 2</h3><img src="../image/graphics/module<?php echo $modules["slot2"] ?>.png" alt="module"><br><select name="module2" >
        ...
        <div class="module3 module_divs"><h3>Module slot 3</h3><img src="../image/graphics/module<?php echo $modules["slot3"] ?>.png" alt="module"><br><select name="module3" >
        ...
        <div class="module4 module_divs"><h3>Module slot 4</h3><img src="../image/graphics/module<?php echo $modules["slot4"] ?>.png" alt="module"><br><select name="module4" >
        ...
        <div class="module5 module_divs"><h3>Module slot 5</h3><img src="../image/graphics/module<?php echo $modules["slot5"] ?>.png" alt="module"><br><select name="module5" >
        ...
        <div class="module6 module_divs"><h3>Module slot 6</h3><img src="../image/graphics/module<?php echo $modules["slot6"] ?>.png" alt="module"><br><select name="module6" >
        ...
        <div class="module7 module_divs"><h3>Module slot 7</h3><img src="../image/graphics/module<?php echo $modules["slot7"] ?>.png" alt="module"><br><select name="module7" >
        ...
        <div class="module8 module_divs"><h3>Module slot 8</h3><img src="../image/graphics/module<?php echo $modules["slot8"] ?>.png" alt="module"><br><select name="module8" >
        ...
        <div class="module9 module_divs"><h3>Module slot 9</h3><img src="../image/graphics/module<?php echo $modules["slot9"] ?>.png" alt="module"><br><select name="module9" >
        ...
        <div class="module10 module_divs"><h3>Module slot 10</h3><img src="../image/graphics/module<?php echo $modules["slot10"] ?>.png" alt="module"><br><select name="module10">
