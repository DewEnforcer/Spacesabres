...
<html>
    <head>
      ...
      <title>SpaceSabres||Equipment</title>
    </head>
  <body>
    ...
    <main>
      ...
      if ($status == true) {
       ...
       ?>
       <script>
         var templates = <?php echo json_encode($templates[$type]).";"; ?>
         console.log(templates)
       </script>
       <section class="equipment_main_wrapper">
         <div class="equipment_header">
           <h2>Equipment</h2>
           <button type="button" name="button" class="btn_save_setup">Save config</button>
         </div>
         <div class="equipment_subheader">
            ...
            <button type="button" class="btn_tmpl" value="save">Save template</button>
         </div>
             ...
             <div class="equipment_slots_ship_info">
               ...
               <div class="info_wrapper">
                 <div class="static_params">
                   ...
                   <?php
                   $ship = $userDock[$i];
                   $paramShipSlots = [[0,4,0,1],[2,2,0,1],[4,0,1,1],[10,0,6,1],[15,0,7,1],[25,0,15,1]];
                   echo "<span>".countEquipped($ship, "lasers")."/".$paramShipSlots[$ship["type"]][0]." Lasers</span>";
                   echo "<span>".countEquipped($ship, "rockets")."/".$paramShipSlots[$ship["type"]][1]." Missiles</span>";
                   echo "<span>".countEquipped($ship, "shields")."/".$paramShipSlots[$ship["type"]][2]." Shields</span>";
                   echo "<span>".countEquipped($ship, "hyperspace")."/".$paramShipSlots[$ship["type"]][3]." Engines</span>";
                    ?>
                 </div>
                 <div class="equip_params">
                   ...
                   echo "<span>Damage: ".number_format($ship["stats"][0], '0', '.',' ')."</span>";
                    ?>
                 </div>
               </div>
             </div>
