...
countRewards($conn, $lostShipsTarget[0], $lostShipsTarget[1], $lostShipsTarget[2], $lostShipsTarget[3], $lostShipsTarget[4], $lostShipsTarget[5], $rewardsHyperids, $rewardsNatiums, $rewardsCredits, $userID); //attacker
if ($targetUserID > 100000) {
countRewards($conn, $lostShipsAttacker[0], $lostShipsAttacker[1], $lostShipsAttacker[2], $lostShipsAttacker[3], $lostShipsAttacker[4], $lostShipsAttacker[5], $rewardsHyperids, $rewardsNatiums, $rewardsCredits, $targetUserID); //defender
}
