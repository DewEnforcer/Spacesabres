...
$(".item").click(function() {
  ...
  $(".items_description").css("display", "flex");
  ...
  $.getJSON( "../js/shop.json", function(jsonItem) {
    ...
    $(".item_desc_wrapper").html("<img src='../image/graphics/closeMsg.png' class='close_shop_popup'><h2 class='item_name'>"+name+"</h2><div class='item_header'></div><div class='item_desc'></div>");
    ...
    $(".item_desc").append(`<div class="amount_wrapper"><span>Amount:</span><div><button type="button" class="btn_amount_minus btn_math">-</button><input type="number" class="items_amount" value="1" min="1"><button type="button" class="btn_amount_plus btn_math">+</button></div></div>`);
    if (action == "ship") {
...
$(document).on("click", ".close_shop_popup", function() {
  $(".items_description").css("display", "none");
})
