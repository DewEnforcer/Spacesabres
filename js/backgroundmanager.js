...
if (time<7) {
  $(document.body).css("background-image", "url('../image/bg/background.webp')");
} else if (time<14) {
  $(document.body).css("background-image", "url('../image/bg/background1.webp')");
} else if (time<21) {
  $(document.body).css("background-image", "url('../image/bg/background2.webp')");
} else if (time<23) {
  $(document.body).css("background-image", "url('../image/bg/background.webp')");
}
$.ajax({
...
function msToTime(duration) {
  ...
  $(".server_time").html("Server time: "+hours+":"+minutes+":"+seconds+"");
}
