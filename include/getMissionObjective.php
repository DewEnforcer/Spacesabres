...
$taskDescsPart1 = ["Collect", "Collect", "Collect", "Build", "Build", "Build", "Build", "Build", "Build", "Win", "Win", "Visit <a href=\"internalBase.php\">battlestation center</a>", "Visit <a href=\"internalShipyard.php\">shipyard</a></li>", "Visit <a href=\"internalResearch.php\">research laboratory</a>", "Take a look on the <a href=\"internalGalaxy.php\">galactic map</a>", "Check your <a href=\"internalInbox.php\">inbox</a>", "Visit your <a href=\"internalFleets.php\">fleet center</a>", "Complete", "Research", "Research", "Research", "Research", "Win", "Stay online for "];
...
if (isset($_POST["id"]) && isset($_SESSION["sid"]) && isset($_POST["status"])) {
  ...
  if ($check == 24) {
    $buttons = '<a href="./include/questcancel.php?id='.$id.'">Cancel the mission</a><a href="../include/questRewards.php?id='.$id.'">Claim your rewards</a>';
  } else {
